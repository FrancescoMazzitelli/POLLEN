"""
Legacy batch submission script.

Sends test queries to the control unit and logs results.
Superseded by benchmark/test_runner.py for dataset-driven evaluation.
"""
...
class Logger:
    """Dual-output logger writing to both terminal and a log file."""
...
try:
    ...
    print(f"Error importing external services: {e}")
